...
#--------------------------------------------------------
#if authenticated & using interactive shell:
createdb datacube owner <username>
...
# Enter the conda environment, will need this environment for subsequent tasks
source activate cubeenv
#initialize the datacube schema
datacube -v system init
#run jupyter notebook server, will launch a browser window. 
jupyter-notebook
...
>>>>>>> 51cf7d31fb0861cb26af5f1fb268d9edc59d5943
